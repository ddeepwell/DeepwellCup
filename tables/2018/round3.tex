...
\begin{table}[h!]
  ...
  \adjustbox{max width=\textwidth}{
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g w w g g w w g g}
        ...
        {\bf East} &&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Tampa Bay Lightning&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Washington Capitals & \mr{TBL} & \mr{6} & \mr{WSH} & \mr{5} & \mr{WSH} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{7} & \mr{TBL} & \mr{5} & \mr{TBL} & \mr{6} & \mr{TBL} & \mr{7} & \mr{WSH} & \mr{7} & \mr{WSH} & \mr{6}\\\hline
          &&&&&&&&&&&&&&&&&&&&&&&&&& \\
        {\bf West} &&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Winnipeg Jets&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Vegas Golden Knights & \mr{VGK} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{5} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{7} & \mr{VGK} & \mr{5} & \mr{WPG} & \mr{6} & \mr{VGK} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{6} & \mr{WPG} & \mr{4} & \mr{WPG} & \mr{7}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}[t]{13cm}
    ...
    \begin{figure}[H]
        \vspace{-1cm}
        \includegraphics[width=12cm,height=8cm,keepaspectratio]{../../figures/2018/Points-2018-Round2.pdf}
    \end{figure}
\end{minipage}
