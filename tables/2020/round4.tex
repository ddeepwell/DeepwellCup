...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g w w g g}
        ...
        \rowcolor{white}\\
        &  \mccg{Alisha K}&  \mcc{Andre D}&  \mccg{Andrew N}&  \mcc{Anthony C}&  \mccg{David D}&  \mcc{Jackson L}&  \mccg{Jon M}&  \mcc{Kollin H}&  \mccg{Kyle L}&  \mcc{Mark D}&  \mccg{Nathan S} \\\thickline
        \\\hline
          TBL&&&&&&&&&&&&&&&&&&&&&&\\
