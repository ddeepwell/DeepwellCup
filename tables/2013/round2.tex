...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g w w g g w w g g w w}
        ...
        {\bf East} &&&&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Pittsburgh Penguins&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Ottawa Senators & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{7} & \mr{OTT} & \mr{7} & \mr{PIT} & \mr{6} & \mr{OTT} & \mr{6} & \mr{OTT} & \mr{5} & \mr{PIT} & \mr{5} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{6} & \mr{OTT} & \mr{6} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{6}\\\hline
          &&&&&&&&&&&&&&&&&&&&&&&&&&&& \\\hline
          Boston Bruins&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          New York Rangers & \mr{BOS} & \mr{7} & \mr{BOS} & \mr{7} & \mr{BOS} & \mr{6} & \mr{BOS} & \mr{7} & \mr{NYR} & \mr{5} & \mr{BOS} & \mr{5} & \mr{NYR} & \mr{7} & \mr{BOS} & \mr{7} & \mr{BOS} & \mr{6} & \mr{NYR} & \mr{7} & \mr{BOS} & \mr{7} & \mr{BOS} & \mr{6} & \mr{NYR} & \mr{7} & \mr{BOS} & \mr{7}\\\hline
          &&&&&&&&&&&&&&&&&&&&&&&&&&&& \\
        {\bf West} &&&&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Chicago Blackhawks&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Detroit Red Wings & \mr{DET} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{5}\\\hline
          &&&&&&&&&&&&&&&&&&&&&&&&&&&& \\\hline
          Los Angeles Kings&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          San Jose Sharks & \mr{LAK} & \mr{7} & \mr{SJS} & \mr{7} & \mr{SJS} & \mr{6} & \mr{SJS} & \mr{7} & \mr{SJS} & \mr{7} & \mr{LAK} & \mr{7} & \mr{LAK} & \mr{7} & \mr{SJS} & \mr{7} & \mr{SJS} & \mr{6} & \mr{SJS} & \mr{6} & \mr{SJS} & \mr{6} & \mr{LAK} & \mr{6} & \mr{LAK} & \mr{5} & \mr{LAK} & \mr{6}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}{12cm}
    ...
    \begin{tabular}{lc | lc | lc | lc }
        PIT & 10 & BOS & 10 & CHI & 13 & LAK & 6 \\
        OTT & 4 & NYR & 4 & DET & 1 & SJS & 8 \\
    \end{tabular}
\end{minipage}
\begin{minipage}[t]{13cm}
    \begin{figure}[H]
        \vspace{-2.5cm}
        \includegraphics[width=13cm]{/Users/daviddeepwell/Documents/Hockey/HockeyPool/DeepwellCup/figures/2013/Points-2013-Round1.pdf}
    \end{figure}
\end{minipage}
