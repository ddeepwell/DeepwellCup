...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g w w g g w w g g w w}
        ...
        {\bf East} &&&&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Pittsburgh Penguins&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Boston Bruins & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{7} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{7} & \mr{BOS} & \mr{6} & \mr{PIT} & \mr{7} & \mr{PIT} & \mr{6} & \mr{BOS} & \mr{6} & \mr{BOS} & \mr{6} & \mr{PIT} & \mr{7} & \mr{PIT} & \mr{7} & \mr{BOS} & \mr{6} & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{5}\\\hline
          &&&&&&&&&&&&&&&&&&&&&&&&&&&& \\
        {\bf West} &&&&&&&&&&&&&&&&&&&&&&&&&&&&\\\hline
          Chicago Blackhawks&&&&&&&&&&&&&&&&&&&&&&&&&&&&\\
          Los Angeles Kings & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{7} & \mr{CHI} & \mr{6}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}[t]{13cm}
    \begin{figure}[H]
        \vspace{-2.5cm}
        \includegraphics[width=13cm]{/Users/daviddeepwell/Documents/Hockey/HockeyPool/DeepwellCup/figures/2013/Points-2013-Round2.pdf}
    \end{figure}
\end{minipage}
