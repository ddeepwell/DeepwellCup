...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w}
        \rowcolor{black}\mcn{13}{\color{white}\bf Round 4: Stanley Cup Finals} \\
        \rowcolor{white}\\
        &  \mccg{Andrew D}&  \mcc{Daniel S}&  \mccg{David D}&  \mcc{Kollin H}&  \mccg{Michael D}&  \mcc{Thomas L} \\\thickline
          Detroit Red Wings&&&&&&&&&&&&\\
          Pittsburgh Penguins & \mr{PIT} & \mr{6} & \mr{PIT} & \mr{7} & \mr{DET} & \mr{7} & \mr{PIT} & \mr{6} & \mr{DET} & \mr{7} & \mr{PIT} & \mr{6}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}[t]{13cm}
    \begin{figure}[H]
        \vspace{-2.5cm}
        \includegraphics[width=13cm]{/Users/daviddeepwell/Documents/Hockey/HockeyPool/DeepwellCup/figures/2008/Points-2008-Round3.pdf}
    \end{figure}
\end{minipage}
