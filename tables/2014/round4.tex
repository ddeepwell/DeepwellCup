...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g}
        ...
        &  \mccg{Andre D}&  \mcc{Charmaine L}&  \mccg{David D}&  \mcc{Kollin H}&  \mccg{Kyle L}&  \mcc{Mark D}&  \mccg{Michael D}&  \mcc{Nathaniel T}&  \mccg{Thomas L} \\\thickline
          Los Angeles Kings&&&&&&&&&&&&&&&&&&\\
          New York Rangers & \mr{LAK} & \mr{6} & \mr{NYR} & \mr{7} & \mr{LAK} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{LAK} & \mr{7} & \mr{NYR} & \mr{7} & \mr{NYR} & \mr{6}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}[t]{13cm}
    \begin{figure}[H]
        \vspace{-2.5cm}
        \includegraphics[width=13cm]{/Users/daviddeepwell/Documents/Hockey/HockeyPool/DeepwellCup/figures/2014/Points-2014-Round3.pdf}
    \end{figure}
\end{minipage}
