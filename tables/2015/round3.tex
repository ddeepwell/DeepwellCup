...
\begin{table}[h!]
    ...
    \begin{tabular}{l g g w w g g w w g g w w g g w w g g w w g g}
        ...
        {\bf East} &&&&&&&&&&&&&&&&&&&&&&\\\hline
          New York Rangers&&&&&&&&&&&&&&&&&&&&&&\\
          Tampa Bay Lightning & \mr{NYR} & \mr{7} & \mr{NYR} & \mr{7} & \mr{TBL} & \mr{7} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{7} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6} & \mr{NYR} & \mr{6}\\\hline
          &&&&&&&&&&&&&&&&&&&&&& \\
        {\bf West} &&&&&&&&&&&&&&&&&&&&&&\\\hline
          Anaheim Ducks&&&&&&&&&&&&&&&&&&&&&&\\
          Chicago Blackhawks & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6} & \mr{ANA} & \mr{7} & \mr{ANA} & \mr{7} & \mr{ANA} & \mr{7} & \mr{ANA} & \mr{7} & \mr{ANA} & \mr{7} & \mr{ANA} & \mr{6} & \mr{CHI} & \mr{6} & \mr{CHI} & \mr{6}\\\hline
          \rowcolor{white}\\
...
\begin{minipage}[t]{13cm}
    \begin{figure}[H]
        \vspace{-2.5cm}
        \includegraphics[width=13cm]{/Users/daviddeepwell/Documents/Hockey/HockeyPool/DeepwellCup/figures/2015/Points-2015-Round2.pdf}
    \end{figure}
\end{minipage}
