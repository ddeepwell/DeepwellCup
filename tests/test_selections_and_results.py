...
class Settings:
    ...
    def __init__(self, empty_database_conn, nonempty_database_conn):
        ...
        self.datastores_nonempty = DataStores(
            pytest.test_data_dir, nonempty_database_conn
        )
...
def fixture_expected_selections(playoff_round):
    ...
    if playoff_round != "Champions":
        playoff_round_selections["Duration"] = playoff_round_selections[
            "Duration"
        ].astype("Int64")
...
def fixture_expected_results(playoff_round):
        ...
        3: DataFrame(
            {
                ...
                "Duration": {("East", "PIT-OTT"): 7, ("West", "ANA-NSH"): 6},
            }
        ),
        4: DataFrame(
            {
    ...
    if playoff_round != "Champions":
        playoff_round_results["Duration"] = playoff_round_results["Duration"].astype(
            "Int64"
        )
